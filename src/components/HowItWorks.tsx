...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" onMouseEnter={() => setAnimate(true)} className="mt-40 mb-20 px-10  md:px-20 md:justify-between justify-center flex flex-col md:flex-row gap-10">
      {/* LEFT — Sticky column */}
      <motion.div
      ...
      <div className="overflow-x-scroll md:overflow-auto [scrollbar-width:none]">
        <div className="flex flex-row  w-180 md:w-full md:flex-col gap-15 text-[#F49B31]">
          <div className="flex flex-col gap-5 items-center">
            <img src={form} alt="" className="w-50 md:w-full" draggable="false"/>
            <p>Claim Your Voice</p>
          </div>
          <div className="flex flex-col gap-5 items-center">
            <img src={surge} alt="" className="w-50 md:w-full" draggable="false"/>
            <p>Drive the Agenda</p>
          </div>
          <div className="flex flex-col gap-5 items-center">
            <img src={action} alt="" className="w-50 md:w-full" draggable="false"/>
            <p>See Real Action</p>
          </div>
        </div>
      </div>
